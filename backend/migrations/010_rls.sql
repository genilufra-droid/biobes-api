...
-- ========== 0) Sigurimi i tabelës company_users ==========
...
BEGIN
  IF to_regclass('public.user_companies') IS NOT NULL THEN
    INSERT INTO public.company_users(company_id, user_id, is_default)
      SELECT company_id, user_id, is_default FROM public.user_companies
